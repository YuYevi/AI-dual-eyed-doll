...
private:
    ...
    static AiDualEyedDollBoard* instance_;
    ...
    void InitializeButtons() {
        ...
        iot_button_register_cb(boot_btn, BUTTON_SINGLE_CLICK, nullptr, [](void* button_handle, void* usr_data) {
            auto self = static_cast<AiDualEyedDollBoard*>(usr_data);
...
AiDualEyedDollBoard* AiDualEyedDollBoard::instance_ = nullptr;
